...
<div class="user_signup_modal">
    ...
    <b-modal id="user-signup-modal" ref="userSignupModal" title="Sign Up" header-bg-variant="primary" @show="resetModal" @hidden="resetModal" @ok=handleOk>
...
export default {
    ...
    methods: {
        ...
        async handleSubmit() {
            ...
            const url = process.env.VUE_APP_ROOT_API + 'user/signup';
            try {
