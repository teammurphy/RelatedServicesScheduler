<template>
  <div class="student_create_modal">
    <b-button variant="primary" v-b-modal.student-create-modal
      ><b-icon-person-plus-fill></b-icon-person-plus-fill> Create New
      Student</b-button
    >
    ...
    >
      ...
      <b-overlay :show="showModalOverlay" rounded="sm">
        <b-form ref="form" @submit.stop.prevent="handleSubmit">
          ...
          >
            <b-form-input id="lastName-input" v-model="form.lastName">
            </b-form-input>
          </b-form-group>
  ...
  methods: {
    checkFormValidity() {
      ...
      if (!isValid) {
        ...
        this.firstNameState =
          this.form.firstName.trim().length > 0 ? true : false;
        this.schoolIdState =
          this.form.schoolId.trim().length > 0 ? true : false;
      } else {
          this.alert = {}
